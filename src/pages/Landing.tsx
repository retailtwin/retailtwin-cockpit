        ...
        <div className="relative container mx-auto px-6 py-24 md:py-32">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <h1 className="text-5xl md:text-6xl font-bold tracking-tight leading-tight">
              Proven Logic, Supercharged<span className="text-primary"></span>
            </h1>
            ...
            <p className="text-base text-muted-foreground max-w-4xl mx-auto leading-relaxed mt-6">
              ...
              should run on rules, not forecasts. We learned from SaaS, and merged proven supply logic with AI — turning
              rules into reliable decisions.
            </p>
