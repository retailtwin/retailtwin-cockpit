        ...
        <div className="container mx-auto px-6">
          <div className="flex h-16 items-center justify-between">
            <Link to="/" className="flex items-center space-x-3">
              ...
              <img src={retailTwinLabsLogo} alt="Retail Twin Labs" className="h-8 w-auto" />
            </Link>
            ...
            <div className="flex items-center space-x-6">
              {isLoggedIn && <>
                  ...
                  {isAdmin && <Link to="/settings" className="text-sm font-medium text-foreground/60 transition-colors hover:text-foreground">
                      Settings
                    </Link>}
                </>}
              ...
              {isLoggedIn ? <Button onClick={handleLogout} variant="outline" size="sm">
                  Logout
